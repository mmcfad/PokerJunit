...
public class TestShuffle {
	...
	public final void TestShuffle() {
		...
		System.out.print("Number of Hi Card Hands           :"
				+ HandResult[0][0]);
		System.out.printf(".....win %4.8f %%" + "\n", (HandResult[0][0] / NbrOfTrials) * 100) ;
